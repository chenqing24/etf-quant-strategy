...
| # | 数据源 | 用途 | 可靠性 | 限速 |
|---|--------|------|--------|------|
| 1 | 腾讯行情API | 实时价格、日线数据 | ⭐⭐⭐⭐⭐ | 2-5秒 |
| 2 | 新浪财经API | 小时线、实时备源 | ⭐⭐⭐⭐ | 2-5秒 |
| 3 | 天天基金网 | ETF基本信息 | ⭐⭐⭐⭐ | 3-6秒 |
| 4 | BaoStock | ETF/股票日线（深交所） | ⭐⭐⭐⭐ | 无严格限制 |
| 5 | 东方财富EMF | 实时备源、个股数据 | ⭐⭐⭐ | 3-6秒 |
| 6 | AKShare | 股票分钟线（参考） | ⭐⭐⭐ | 无严格限制 |
| 7 | Tushare | 日线备源（需Token） | ⭐⭐⭐⭐ | 有限制 |
...
| high | 日线[2] | - | 字段high |
| low | 日线[3] | - | 字段low |
| close | 日线[4] | 索引3 | 字段close |
| volume | 日线[5] | - | 字段volume |
