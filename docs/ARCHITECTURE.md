...
| **ETF实时价格** | 腾讯API | 东方财富EMF | 新浪 | **浏览器搜索** |
| ETF小时线 | 新浪scale=30 | — | — | — |
...
`TradeValidator.fetch_realtime_prices()` 的实际调用顺序：
...
| 代码前缀 | 市场 | 示例 |
|---------|------|------|
| 159xxx | 深圳(SZ) | 159806 新能源车 |
| 510xxx | 上海(SH) | 510300 沪深300 |
| 515xxx | 上海(SH) | 515050 5GETF |
| 588xxx | 上海(SH) | 588000 科创50 |
...
- [ ] **实时价格获取：调用API而非热数据缓存，API失败时标注"昨收盘"**

---

*文档版本: v2.5 | 创建日期: 2026-05-25 | 更新: 2026-05-27 - 修复ETF代码前缀判断，159xxx正确识别为深交所*