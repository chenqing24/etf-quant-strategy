...
| 数据类型 | 主力源 | 回溯时长 | 备源 |
|---------|-------|---------|------|
| **ETF日线（上交所）** | 腾讯API直连 | ~300天 | Tushare |
| **ETF日线（深交所）** | BaoStock | ~300天 | Tushare |
| **ETF实时价格** | 新浪→BaoStock | 当日 | 东方财富EMF（最后） |
...
*文档版本: v2.2 | 创建日期: 2026-05-25 | 更新: 2026-05-27 - 实测确认BaoStock支持深交所ETF，腾讯支持上交所ETF*